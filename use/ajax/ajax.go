...
type (
	...
	ResourceWithPatch interface {
		Patch(context.Context, data.Patch) error
	}
)
...
func Get(resource ResourceWithGet) js.String {
	return js.String(fmt.Sprintf("ajax.get('%v')", data.PathOf(resource)))
}
...
func Search(resource ResourceWithSearch) js.String {
	return js.String(fmt.Sprintf("ajax.search('%v')", data.PathOf(resource)))
}
...
func Post(resource ResourceWithPost) js.String {
	return js.String(fmt.Sprintf("ajax.post('%v')", data.PathOf(resource)))
}

// Put returns javascript that will write the given
// resource idempotently.
func Put(resource ResourceWithPut) js.String {
	return js.String(fmt.Sprintf("ajax.put('%v')", data.PathOf(resource)))
}

// Delete returns javascript that will delete the given
// resource idempotently.
func Delete(resource ResourceWithDelete) js.String {
	return js.String(fmt.Sprintf("ajax.delete('%v')", data.PathOf(resource)))
}

// Patch returns javascript that will patch the given
// resource with the given patch.
func Patch(resource ResourceWithPatch, patch data.Patch) js.String {
	return js.String(fmt.Sprintf("ajax.patch('%v')", data.PathOf(resource)))
}
...
func pathsOf(rvalue reflect.Value, into map[string]http.Handler) {
	...
	into[data.PathOf(rvalue.Addr().Interface())] = resource{rvalue.Type()}
...
// in the given value.
func HandlersOf(states ...any) map[string]http.Handler {
